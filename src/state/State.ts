...
export const ATELIERS: Record<number, Atelier> = {
    ...
    8: { code: 'FresqueSexisme', logo: 'logo_fresqueSexisme.png', nom: 'Fresque du Sexisme', promoted: true, website: 'https://fresque-du-sexisme.org/', styleCode: '_fresqueSexisme' },
