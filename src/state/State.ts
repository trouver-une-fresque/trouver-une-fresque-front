...
export const ATELIERS: Record<number, Atelier> = {
    ...
    8: { code: 'FresqueSexisme', logo: 'logo_fresqueSexisme.webp', nom: 'Fresque du Sexisme', promoted: true, website: 'https://www.facebook.com/FresqueDuSexisme/', styleCode: '_fresqueSexisme' },
