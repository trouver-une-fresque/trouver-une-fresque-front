...
export const ATELIERS: Record<number, Atelier> = {
    ...
    8: { code: 'FresqueSexisme', logo: 'logo_fresqueSexisme.webp', nom: 'Fresque du Sexisme', promoted: false, website: 'https://www.facebook.com/FresqueDuSexisme/', styleCode: '_fresqueSexisme' },
    10: { code: 'AtelierNosViesBasCarbone', logo: 'logo_NVBC.webp', nom: 'Nos Vies Bas Carbone', promoted: true, website: 'https://www.nosviesbascarbone.org/', styleCode: '_atelierNVBC' },
    11: { code: 'FresqueDeLeau', logo: 'logo_fresqueDeLeau.webp', nom: 'Fresque de l\'Eau', promoted: true, website: 'https://www.eaudyssee.org/', styleCode: '_fresqueDeLeau' },
    12: { code: 'FutursProches', logo: 'logo_FutursProches.webp', nom: 'Futurs Proches', promoted: true, website: 'https://futursproches.com/', styleCode: '_futursProches' },
    13: { code: 'FresqueDiversite', logo: 'logo_fresqueDiversite.webp', nom: 'Fresque de la Diversité', promoted: true, website: 'https://fresquedeladiversite.org/', styleCode: '_fresqueDiversite' },
    14: { code: 'FresqueDuTextile', logo: 'logo_FresqueTextile.webp', nom: 'Fresque du Textile', promoted: true, website: 'https://greendonut.org/', styleCode: '_fresqueTextile' },
